...
//存储已有的销售属性值的数组
export type SpuAttrValuesList = SaleAttrValue[];
...
export interface SaleAttr {
    ...
    baseSaleAttrId: number | string,
    saleAttrName: string,
    spuSaleAttrValueList: SpuAttrValuesList,
    flag?: boolean,
    saleAttrValue?: string

}

//SPU正有的销售属性接口返回数据ts类型
export interface SaleAllResponseData extends ResponseData {
    data: SaleAttr[],
