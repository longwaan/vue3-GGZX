...
<template>
  <div>
    ...
    <el-card style="margin-top: 20px;">
      <div v-show="scene === 0">
        <el-button icon="Plus" type="primary" @click="addSpu" :disabled="categoryStore.c3Id?false:true">添加SPU</el-button>
        <el-table :data="spuAttr" style="width: 100%;margin: 20px 0px;" border>
          ...
          <el-table-column label="操作">
            <template #="{ row, index }">
              <el-button icon="Plus" title="添加sku" type="primary" size="small"></el-button>
      ...
      <sku-from v-show="scene === 2" @changeScene="changeScene"></sku-from>
    </el-card>
  </div>
</template>
